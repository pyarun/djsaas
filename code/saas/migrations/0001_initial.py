...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'saas_user_groups')
        ...
        m2m_table_name = db.shorten_name(u'saas_user_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'saas.user'], null=False)),
    ...
    def backwards(self, orm):
        # Deleting model 'User'
        db.delete_table(u'saas_user')

        # Removing M2M table for field groups on 'User'
        db.delete_table(db.shorten_name(u'saas_user_groups'))
