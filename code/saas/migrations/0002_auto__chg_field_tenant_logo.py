...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tenant.logo'
        db.alter_column(u'saas_tenant', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Tenant.logo'
        db.alter_column(u'saas_tenant', 'logo', self.gf('django.db.models.fields.files.ImageField')(default=0, max_length=100))
    ...
    models = {
        ...
        u'saas.tenant': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['saas.User']", 'symmetrical': 'False'})
        },
        u'saas.user': {
