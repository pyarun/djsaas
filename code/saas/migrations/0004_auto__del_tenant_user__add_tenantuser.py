...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TenantUser'
        db.create_table(u'saas_tenantuser', (
        ...
        db.send_create_signal(u'saas', ['TenantUser'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'TenantUser'
        db.delete_table(u'saas_tenantuser')
    ...
    models = {
        ...
        u'saas.tenant': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['saas.User']", 'null': 'True', 'through': u"orm['saas.TenantUser']", 'blank': 'True'})
        },
        u'saas.tenantuser': {
            'Meta': {'object_name': 'TenantUser'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
