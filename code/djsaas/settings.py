...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/arun/workspace/djsaas/code/djsaas.sqlite',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'd!-)7+4a#6=vhxisltrs7#qs&ofrgj1*f80+yh9p_^tsq-@8=p'
...
MIDDLEWARE_CLASSES = (
    ...
    'saas.middleware.OrganizationMiddleware',
...
ROOT_URLCONF = 'djsaas.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'djsaas.wsgi.application'
